...
public class FlowchartSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FlowchartPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartPackage.STEP: {
			...
			case FlowchartPackage.SPEAK_ACTION: {
			...
			case FlowchartPackage.REDIRECT_ACTION: {
				RedirectAction redirectAction = (RedirectAction)theEObject;
				T result = caseRedirectAction(redirectAction);
				if (result == null) result = caseAction(redirectAction);
				if (result == null) result = caseStep(redirectAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartPackage.INPUT_ACTION: {
